...
const Footer = () => {
    return (
        <footer className='w-full h-40 mt-8 flex justify-center items-center text-sm bottom-0 relative' style={{background: '#ded7cf'}}>
            ...
            <div className='w-4/12 flex justify-center items-center'>
                @ Copyright by 2022 <span className='font-bold'>&nbsp;Daniel Kristiawan.&nbsp;</span>All right reserved
            </div>
        </footer>
    )
}
