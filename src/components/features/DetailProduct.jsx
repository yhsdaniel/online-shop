...
const DetailProduct = () => {
    ...
    useEffect(() => {
        dispatch(getDetailProduct(detailProduct.id))
    }, [])
                ...
                <div className='h-screen'>
                    <div className='h-full flex justify-center items-center bg-white mx-40 mt-4 p-8 rounded-lg'>
                        <div className='w-6/12 h-80 flex justify-center items-center m-4'>
                            <img src={detailProduct.image} alt="Sample Image" className='w-5/12' />
                        </div>
                        <div className='w-6/12 h-80 flex justify-center items-center flex-col m-4'>
                            ...
                            <div className="w-full h-full">
                                <button className="w-32 p-2 mr-2 bg-red-100 border border-red-500 text-red-600 hover:bg-gray-50 hover:ease-in-out duration-300 rounded-md" onClick={() => linkToCart()}>Add to Cart</button>
